...
const searchResults: SearchResult[] = [
  {
    id: 1,
    title: "React 개발의 기초",
    description: "React의 기본을 배워봅시다.",
    tags: ["React", "Frontend"],
  },
  {
    id: 2,
    title: "Next.js로 SSR 적용하기",
    description: "Next.js를 이용해서 서버 사이드 랜더링을 구현하는 방법.",
    tags: ["Next.js", "SSR"],
  },
  {
    id: 3,
      ...
      <main className="container mx-auto p-4">
        <section className="bg-gray-200 mt-4 p-4 rounded-lg h-30 flex items-center justify-between">
          <div className="flex flex-col justify-around h-full">
            ...
            <p className="font-light">N개의 결과를 찾았습니다.</p>
          </div>
        </section>
            ...
            results.map((result) => (
              <div key={result.id} className="border p-4 rounded-lg">
                ...
                <div className="flex gap-2 mt-2">
                  {result.tags.map((tag) => (
                    <span key={tag} className="bg-gray-200 text-sm p-1 rounded">
                      {tag}
                    </span>
                  ))}
                </div>
